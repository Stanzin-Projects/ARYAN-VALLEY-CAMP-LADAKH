...
const AnimatedNavLink = ({ href, children }) => {
  ...
  return (
    <a 
      href={href} 
      className={`group relative flex overflow-hidden h-5 items-center ${textSizeClass}`}
    >
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        ...
        <button 
          className="sm:hidden flex items-center justify-center w-8 h-8 text-gray-300 focus:outline-none hover:text-white transition-colors" 
          onClick={toggleMenu} 
